...
class Participant(models.Model):
    ...
    club = models.ForeignKey(Club, on_delete=models.CASCADE)
    verification_code = models.ForeignKey(VerificationCode, on_delete=models.CASCADE)

class Duel(models.Model):
    participant_one = models.ForeignKey(Participant, on_delete=models.CASCADE, related_name="participant_one")
    participant_two = models.ForeignKey(Participant, on_delete=models.CASCADE, related_name="participant_two")
    parent_duel = models.ForeignKey('self', on_delete=models.DO_NOTHING)
    winner = models.ForeignKey(Participant, on_delete=models.CASCADE, related_name="weiner")
